...
### Rebecca Bigelow {:.hidden-header}
<div style="display: grid; grid-template-columns: 1fr 2fr; grid-template-rows: auto auto; gap: 10px; padding: 10px;">
  <div style="grid-column: 2; grid-row: 1 / span 2; text-align: center;">
    <img src="" alt=""  loading="lazy" width="200" style="margin-right: 20px;"/>
  </div>
  <div style="grid-column: 1; grid-row: 1;">
    <h2>Rebecca Bigelow</h2>
    <h3>MS, Animal Science
rabigelow1@buffs.wtamu.edu</h3>
  </div>
  <div style="grid-column: 1 / span 2; grid-row: 2;">
...
<div style="display: grid; grid-template-columns: 1fr 2fr; grid-template-rows: auto auto; gap: 10px; padding: 10px;">
  ...
  <div style="grid-column: 1; grid-row: 1;">
    <h2>Jaye Hawkins</h2>
    <h3>Administrative coordinator for VERO</h3>
  </div>
  <div style="grid-column: 1 / span 2; grid-row: 2;">
...
### Kushal Lamsal (Sal) {:.hidden-header}
<div style="display: grid; grid-template-columns: 1fr 2fr; grid-template-rows: auto auto; gap: 10px; padding: 10px;">
  <div style="grid-column: 2; grid-row: 1 / span 2; text-align: center;">
    <img src="" alt=""  loading="lazy" width="200" style="margin-right: 20px;"/>
  </div>
  ...
  <div style="grid-column: 1 / span 2; grid-row: 2;">
    <p>Sal is a senior Undergraduate Biology/Biochemistry student who works at the VERO research lab as a student research assistant. Born and raised in Kathmandu, Nepal now he calls Long Island, New York his home. During free time he enjoys reading and learning new things.</p>
  </div>
</div>

--------

### Hudson McAllister {:.hidden-header}
<div style="display: grid; grid-template-columns: 1fr 2fr; grid-template-rows: auto auto; gap: 10px; padding: 10px;">
  <div style="grid-column: 2; grid-row: 1 / span 2; text-align: center;">
    <img src="" alt=""  loading="lazy" width="200" style="margin-right: 20px;"/>
  </div>
  <div style="grid-column: 1; grid-row: 1;">
    <h2>Hudson McAllister</h2>
    <h3>PhD, Biomedical Sciences (Infection, Immunity & Epidemiology)
hmcallister15@tamu.edu</h3>
  </div>
  <div style="grid-column: 1 / span 2; grid-row: 2;">
...
<div style="display: grid; grid-template-columns: 1fr 2fr; grid-template-rows: auto auto; gap: 10px; padding: 10px;">
  ...
  <div style="grid-column: 1; grid-row: 1;">
    ...
    <h3>PhD, Biomedical Sciences (Biomedical Genomics & Bioinformatics)
ramirez_b@tamu.edu</h3>
  </div>
  <div style="grid-column: 1 / span 2; grid-row: 2;">
...
<div style="display: grid; grid-template-columns: 1fr 2fr; grid-template-rows: auto auto; gap: 10px; padding: 10px;">
 ...
 https://www.ncbi.nlm.nih.gov/myncbi/james.young.6/bibliography/public/</p>
  </div>
</div>

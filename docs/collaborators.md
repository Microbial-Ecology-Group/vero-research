...
--------
### Mahesh N. Nair {:.invisible-header}
<div style="display: grid; grid-template-columns: 2fr 3fr; grid-template-rows: auto auto; gap: 2px; padding: 2px;">
  <div style="grid-column: 1; grid-row: 1 / span 2; text-align: center;">
  <img src="../assets/MaheshNair.jpg" alt=""  loading="lazy" width="200" style="margin-right: 2px;"/>
  <h2><b>Mahesh N. Nair, MS, PhD</b></h2>
...
### John L. Pipkin {:.invisible-header}
  ...
  <h2><b>John L. Pipkin, MS, PhD</b></h2>
    <h3>Executive Director, Equestrian Center<br>
      Texas Tech University</h3>
    <p>-- <a href="mailto:john.pipken@ttu.edu">john.pipken@ttu.edu</a><br><br>
 </div>
  <div style="grid-column: 2; grid-row: 1; text-align: left;">
      <p>John Pipkin is currently the Executive Director of the Texas Tech Equestrian Center where he oversees the daily operations and management of the teaching, research, and outreach activities of the Texas Tech Equine Program that includes the Texas Tech Therapeutic Riding Center and the competitive Equine-related teams including the Equestrian, Horse Judging, Ranch Horse, and Rodeo teams. After serving for 30 years as the Director of the Equine Industry Program, and a Regents Professor and Engler Professor of Animal Science at West Texas A&M University, he served as the Director of Officials at the American Quarter for Association from December 2023 to September 2024.  His instructional duties at WTAMU included Reproductive Physiology, graduate Endocrinology, portions of Anatomy and Physiology, Professional Leadership, and Selection and Evaluation.  As Equine Program Director at WTAMU, he oversaw the teaching, research, and service duties related to the Equine Program, and Faculty Supervisor of the WT Horse Center. He coached the Horse Judging team and oversaw the Equestrian and Ranch Horse teams. He has been an approved horse show judge for over 30 years for multiple associations, and has judged over 500 total shows in 13 different countries and over 20 World and National Championships. Pipkin’s judging teams won 160 National or World Champion or Reserve Champion titles; and Equestrian and Ranch Teams under his program direction and/or coaching won over 60 National Champion or Reserve Champion titles. He trained and showed horses professionally in many disciplines. Pipkin still works closely with several Equine and Breed Associations where he collaborates with various committees. He is a National Director for AQHA, has served as Chair of the AQHA Judges Committees, AQHA Show and Professional Horsemen Committee, and the AQHA Show Council. Dr. Pipkin was awarded the Outstanding Young Professional Award by the Equine Science Society, Texas 4-H Alumni Award, and the 2023 AQHA Don Burt Professional Horseman of the Year. At WT, he received the Magister Optimus award, the university’s highest faculty recognition, and University Teaching Excellence award. The Texas A&M University System awarded him the Teaching Excellence Award and named him a Regents Professor. In addition, he received numerous Texas A&M System Regent’s resolutions and WT President’s Silver Buffalo awards; received the West Texas A&M University First Choice award, was inducted into the Texas Tech Department of Animal & Food Sciences Hall of Fame; and has over 200 publications, given over 100 invited professional presentations, chaired or been a member of over 75 graduate student committees, and secured over $6.0 million in donations, grants, and gifts. </p>
  </div>
</div>
--------
